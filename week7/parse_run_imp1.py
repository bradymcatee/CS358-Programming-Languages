from interp_imp1 import Program, Block, Decl, VarDecl, \
                       Assign, Ifnz, Whilenz, For, Print, Stmt, \
...
parser = Lark(Path('imp1.lark').read_text(),start='block',ambiguity='explicit')
...
class ToProgram(Transformer[Token,Program]):
    ...
    def for_(self, args:tuple[str, Expr, Expr, Stmt]) -> Stmt:
        return For(args[0], args[1], args[2], args[3])
