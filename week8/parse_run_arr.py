from interp_arr import Add, Sub, Mul, Div, Neg, Let, Name, Lit, Ifnz, Letfun, App, Arr, Get, Set, Seq, Expr, run
...
parser = Lark(Path('expr_arr.lark').read_text(),start='expr',ambiguity='explicit')
